<%-- 
    Document   : cart1overall
    Created on : Jul 15, 2020, 8:30:45 PM
    Author     : hp
--%>
...
<html>
    ...
    <center>
        <h1> <br/><br/><p style="background-color: #57293e; opacity: 0.8; color: #fff"> <font size="100">Overall Caster-in-Role</font></p></h1>
        <div class="limiter">
                                            ...
                                            <tr class="row100">
                                                ...
                                                <td class="column100 column6" data-column="column6">
                                                    <form action="Cart1MainController" method="POST">
                                                        <input type="hidden" name="textIdShotAcc1" value="${dto.idAccShot}"/>
        ...
        <a href="Cart1SearchController"><h3> <p style="background-color: #fff; color: #0080ff" >Back to the caster- scene manager here!</p></h3> </a>
        <br/><br/><br/><br/>  
