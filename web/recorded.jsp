...
<html>
    ...
    <center>
        <h1> <br/><br/><p style="background-color: #57293e; opacity: 0.8; color: #fff"> <font size="100">VIDEOTAPPED SCENES</font></p></h1>
        <br/> <br/> <br/>
        <br/><br/>
        <div class="limiter">
            <c:if test="${requestScope.INFOCASTER2 != null}" >
                <c:if test="${not empty requestScope.INFOCASTER2}" var = "searching">
                        ...
                        <div class="wrap-table100">
                            <div class="table100 ver6 m-b-110">
                                <table data-vertable="ver6">
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.INFOCASTER2}" var="dto" varStatus="counting">
                                            <tr class="row100">
