 ...
 * @author hp
 */
public class ToolRegisterController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "toolmanagement.jsp";
    private static final String INVALID = "addtool.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!toolstatus.matches("^[a-zA-Z0-9]{1,50}$")) {
                c = false;
                oreo.setToolstatusError("Tool's status must be 1- 5- chars");
            }
            ...
            if (!c) {
                ...
                boolean check = beans.toolInsert();
                if (check) {
                    url = SUCCESS;
                }
                if (!check) {
...
//            log("ERROR at Tool Register Controller: " + e.getMessage());
                e.printStackTrace();
            }
        } finally {
