...
import hieudn.db.DateConverter;
 ...
 * @author hp
 */
public class TakeRegisterController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "takemanagement.jsp";
    private static final String INVALID = "addtake.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!idtake.matches("^[a-zA-Z0-9]{1,81}$")) {
                c = false;
                oreo.setIdtakeError("Make it unique by giving an ID! (<81)");
            }
            ...
            if (!c) {
                ...
                if (!checkDate(startDate, endDate)) {
                    ...
                    boolean check = beans.takeInsert();
                    if (check) {
                        url = SUCCESS;
                    }
                    if (!check) {
                        request.setAttribute("ERROR", "Error occurs during take inserting");
                    }
                }
            }
